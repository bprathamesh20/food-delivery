...
public class PaymentService {
    ...
    private PaymentEvent toEvent(Payment payment, String status, String reason) {
        return PaymentEvent.builder()
                .eventType("PAYMENT_" + status)
                .orderId(parseOrderId(payment.getOrderId()))
    ...
    private Long parseOrderId(String orderId) {
        ...
        try {
            ...
            // If orderId is not numeric, return null or use a hash
            return null;
        }
    }
